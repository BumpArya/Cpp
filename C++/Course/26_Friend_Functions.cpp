...
even though they are not defined inside the class.

It is necessary to write the prototype of the friend function

If we have written the prototype for the friend function in the class 
...
class Complex{
    int a, b;
    friend Complex sumComplex(Complex o1, Complex o2); // Declaring friend function
    public:
